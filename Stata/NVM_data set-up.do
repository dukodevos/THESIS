...
local path "J:\Data\Residential property data (NVM)\1985-2013\"
local path "I:ScienceUK\Data\Residential property data (NVM)\1985-2013\"

use "`path'\NVM_raw.dta", clear
